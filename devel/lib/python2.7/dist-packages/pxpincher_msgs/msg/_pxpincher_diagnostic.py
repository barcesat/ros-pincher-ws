...
"""autogenerated by genpy from pxpincher_msgs/pxpincher_diagnostic.msg. Do not edit."""
import sys
...
class pxpincher_diagnostic(genpy.Message):
  _md5sum = "f3f83b09c5779aeca355cee05458d490"
  _type = "pxpincher_msgs/pxpincher_diagnostic"
...
string frame_id
"""
  __slots__ = ['header','name','voltage','temperature']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,voltage,temperature
    ...
    """
    if args or kwds:
      super(pxpincher_diagnostic, self).__init__(*args, **kwds)
